...
export const userLoginByToken = async () => {
  ...
  // Đoạn code này sẽ gửi một yêu cầu POST đến endpoint /auth/token để lấy thông tin người dùng dựa trên token đã lưu trong cookie. 
  // const url = "https://192.168.41.26/auth/token";
  // const response = await axios.post(url, {}, { withCredentials: true });
  // return response;

  // Mở rộng API giả lập để phát triển giao diện mà không cần phụ thuộc vào backend
  return {
    status: 200,
    data: {
      _id: "test123",
